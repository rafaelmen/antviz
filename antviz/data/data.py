...
#geolocales_raw_df = pd.read_csv('antviz_choropleth.csv')
## load via choropleth data via csv for map
#choropleth_url = 'https://raw.githubusercontent.com/rafaelmen/anviz_data/master/antviz_choropleth.csv'
#geolocales_raw_df = pd.read_csv(choropleth_url)
